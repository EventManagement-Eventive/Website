...
<div class="limiter">
		<div class="container-login100">
			...
			<form class="login100-form validate-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					<img src="images/Head.png" alt="logo" width="400" height="100">
					<br>
					<br>
					<span class="login100-form-title p-b-43">
						Sign Up
					</span>
					<div class="wrap-input100 validate-input <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>" data-validate = "Valid name is required: abc">
					...
					<div class="wrap-input100 validate-input <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>" data-validate="Password is required">
						<input class="input100" type="password" name="confirm_password" value="<?php echo $confirm_password; ?>">
				...
				<div class="login100-more" style="background-image: url('images/signup.jpg');">
				</div>
			</div>
		</div>
	</div>
